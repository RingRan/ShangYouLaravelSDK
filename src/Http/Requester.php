...
class Requester
{
    ...
    public function __construct(Container $app)
    {
        ...
        // 合并本地配置的服务域名
        $this->domains = array_merge($this->domains,
            $this->config['service_domains']);
    }
    ...
    private function _request(
        ...
        // 提供当前用户信息
        // if (!$this->withoutUserInfo && !Auth::guest()) {
        //     $user                    = Auth::user();
        //     $headers['X-USER']       = $user->id;
        //     $headers['X-ENTERPRISE'] = $user->enterprise_id;
        // }

        // // 平台ID
        // $platformId = $this->getPlatformId();
        // if (!empty($platformId)) {
        //     $headers['X-PLATFORM'] = $platformId;
        // }
